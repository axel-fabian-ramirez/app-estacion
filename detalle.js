...
function procesar(datos, addData = true){
	...
	temp_val_int.innerHTML = datos[0].temperatura.split(".")[0];
	temp_val_dec.innerHTML = "."+datos[0].temperatura.split(".")[1];
	...
	document.querySelector("#sen_max").innerHTML = datos[0].sensamax + "°C"
	document.querySelector("#sen_min").innerHTML = datos[0].sensamin + "°C"
